...
public class AppData {
    ...
    public static class App {
        ...
        public static final long SPECIFIC_MSG_ID = 4;
        ...
        public static String SPECIFIC_MSG = "您购物车中包含不同类别的商品";
    ...
    public static class Url {
         ...
         * 服务器域名
         */
        public static String domain = "http://182.150.37.95:8081/Banjiuwan/";                                     //正式服务器
